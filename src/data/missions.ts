import { expansionMissions } from './expansion-missions'
...
export type DistrictVariant = Pick<Mission, 'openingSyndrome' | 'brief' | 'initialData' | 'disease' | 'diagnoses' | 'diagnosticCheck' | 'clues' | 'interventions' | 'requiredInterventions' | 'priorityAction' | 'cycleEvents' | 'debrief' | 'learningPoints' | 'source'> & { id: string; label: string }
...
export const districtVariants: DistrictVariant[] = [
  {
    id: 'dengue', label: 'Dengue', openingSyndrome: 'Síndrome febril aguda em área urbana', brief: 'Prontos atendimentos do distrito registram aumento de febre aguda com cefaleia e mialgia após chuvas recorrentes.', initialData: [{ label: 'Mediana de idade', value: '24 anos' }, { label: 'Início', value: '4–7 dias' }, { label: 'Contexto', value: 'Chuvas recorrentes' }], disease: 'Dengue', diagnoses: ['Dengue', 'Chikungunya', 'Zika', 'Leptospirose', 'Influenza'], diagnosticCheck: { question: 'Qual conjunto tem maior valor para diferenciar a principal hipótese?', options: [{ id: 'a', label: 'Febre alta, dor retro-orbitária, mialgia, exantema e exposição a Aedes.' }, { id: 'b', label: 'Artralgia incapacitante e persistente como queixa predominante.' }, { id: 'c', label: 'Conjuntivite não purulenta e prurido como queixas centrais.' }, { id: 'd', label: 'Tosse produtiva e infiltrado lobar.' }], correctId: 'a' }, clues: { emergencia: [{ id: 'dgv-em', role: 'emergencia', category: 'Clínica', level: 1, title: 'Primeira avaliação', text: 'Febre alta, cefaleia, dor retro-orbitária, mialgia e náusea são frequentes; parte apresenta exantema.' }], infectologia: [{ id: 'dgv-in', role: 'infectologia', category: 'Vigilância', level: 1, title: 'Diferenciais arbovirais', text: 'Sintomas isolados não separam de modo confiável dengue, chikungunya e Zika.' }], epidemiologia: [{ id: 'dgv-ep', role: 'epidemiologia', category: 'Exposição', level: 1, title: 'Mapa territorial', text: 'Casos se concentram onde há recipientes descobertos e armazenamento intermitente de água.' }], laboratorio: [{ id: 'dgv-la', role: 'laboratorio', category: 'Laboratório', level: 1, title: 'Teste direcionado', text: 'A detecção direta na fase inicial sustenta infecção por vírus transmitido por Aedes.' }] }, interventions: [{ id: 'vector', icon: '🦟', label: 'Vetores', title: 'Eliminar criadouros', text: 'Remover e manejar recipientes com água de forma territorial.', tone: 'green', factor: .62 }, { id: 'triage', icon: '🩺', label: 'Assistência', title: 'Implantar triagem de risco', text: 'Reconhecer sinais de alarme e organizar avaliação prioritária.', tone: 'orange', factor: .7 }, { id: 'surveillance', icon: '📈', label: 'Vigilância', title: 'Atualizar curva de casos', text: 'Monitorar tendência e distribuição espacial.', tone: 'blue', factor: .83 }, { id: 'communication', icon: '📣', label: 'Comunicação', title: 'Mobilizar o território', text: 'Orientar eliminação de criadouros e procura diante de sinais de alarme.', tone: 'purple', factor: .88 }], requiredInterventions: ['vector', 'triage'], priorityAction: { label: 'PRIORIDADE ASSISTENCIAL', title: 'Organizar triagem de sinais de alarme', text: 'A equipe separa rapidamente pacientes que pedem avaliação imediata.', action: 'Abrir triagem', completion: 'Triagem ativa', metricLabel: 'TRIAGEM', before: 'sob pressão', after: 'organizada' }, cycleEvents: [], debrief: 'O caso é dengue. Febre alta, dor retro-orbitária, mialgia, contexto de Aedes e investigação adequada sustentam a hipótese.', learningPoints: ['Arboviroses compartilham achados clínicos.', 'Sinais de alarme exigem reavaliação imediata.', 'O controle vetorial depende de ação ambiental contínua.'], source: { label: 'OMS — Dengue', url: 'https://www.who.int/en/news-room/fact-sheets/detail/dengue-and-severe-dengue' } },
  {
    id: 'zika', label: 'Zika', openingSyndrome: 'Exantema pruriginoso em área urbana após chuvas', brief: 'Moradores procuram atendimento por exantema, prurido e sintomas leves após aumento de mosquitos no distrito.', initialData: [{ label: 'Queixa dominante', value: 'Prurido e exantema' }, { label: 'Febre', value: 'Baixa ou ausente' }, { label: 'Contexto', value: 'Chuvas recorrentes' }], disease: 'Zika', diagnoses: ['Zika', 'Dengue', 'Chikungunya', 'Sarampo', 'Leptospirose'], diagnosticCheck: { question: 'Qual conjunto torna a principal hipótese mais consistente?', options: [{ id: 'a', label: 'Exantema pruriginoso, febre baixa, conjuntivite não purulenta e exposição a Aedes.' }, { id: 'b', label: 'Febre alta com dor retro-orbitária intensa e sinais de alarme.' }, { id: 'c', label: 'Febre súbita com poliartralgia intensa e incapacitante.' }, { id: 'd', label: 'Tosse, coriza e exantema após pródromo respiratório.' }], correctId: 'a' }, clues: { emergencia: [{ id: 'zk-em', role: 'emergencia', category: 'Clínica', level: 1, title: 'Padrão de chegada', text: 'Predominam exantema pruriginoso, febre baixa, conjuntivite não purulenta e artralgia leve.' }], infectologia: [{ id: 'zk-in', role: 'infectologia', category: 'Vigilância', level: 1, title: 'Cuidado na comunicação', text: 'A orientação deve incluir proteção contra picadas e atenção especial a pessoas gestantes, conforme protocolos locais.' }], epidemiologia: [{ id: 'zk-ep', role: 'epidemiologia', category: 'Exposição', level: 1, title: 'Território favorável', text: 'Há aumento de recipientes com água parada em torno das residências e circulação de Aedes.' }], laboratorio: [{ id: 'zk-la', role: 'laboratorio', category: 'Laboratório', level: 1, title: 'Confirmação necessária', text: 'O quadro se sobrepõe a outras arboviroses; a confirmação depende de método e momento adequados.' }] }, interventions: [{ id: 'vector', icon: '🦟', label: 'Vetores', title: 'Eliminar criadouros', text: 'Mobilizar o manejo de recipientes que acumulam água.', tone: 'green', factor: .62 }, { id: 'risk-communication', icon: '📣', label: 'Comunicação', title: 'Comunicar proteção e cuidado', text: 'Orientar prevenção de picadas e busca de avaliação conforme protocolos locais.', tone: 'orange', factor: .7 }, { id: 'surveillance', icon: '📈', label: 'Vigilância', title: 'Mapear notificações', text: 'Acompanhar a distribuição territorial dos casos.', tone: 'blue', factor: .83 }, { id: 'care-access', icon: '🩺', label: 'Assistência', title: 'Facilitar avaliação', text: 'Organizar acolhimento e orientação para pessoas sintomáticas.', tone: 'purple', factor: .88 }], requiredInterventions: ['vector', 'risk-communication'], priorityAction: { label: 'PRIORIDADE DE CUIDADO', title: 'Organizar orientação de risco', text: 'A equipe oferece orientação clara e direciona pessoas que precisam de avaliação.', action: 'Ativar orientação', completion: 'Orientação ativa', metricLabel: 'CUIDADO', before: 'disperso', after: 'organizado' }, cycleEvents: [], debrief: 'O caso é Zika. Exantema pruriginoso, conjuntivite não purulenta, febre baixa e contexto de Aedes sustentam a hipótese, que requer confirmação laboratorial.', learningPoints: ['Arboviroses podem ter apresentações semelhantes.', 'A confirmação laboratorial depende do momento da doença.', 'Controle vetorial e comunicação de risco são centrais.'], source: { label: 'OMS — Zika', url: 'https://www.who.int/westernpacific/newsroom/fact-sheets/detail/zika-virus' } },
  {
    id: 'chikungunya', label: 'Chikungunya', openingSyndrome: 'Febre aguda com dor articular intensa', brief: 'Após chuvas recorrentes, moradores relatam febre de início súbito e dor articular que dificulta tarefas cotidianas.', initialData: [{ label: 'Queixa dominante', value: 'Dor articular intensa' }, { label: 'Início', value: 'Súbito' }, { label: 'Contexto', value: 'Aedes no território' }], disease: 'Chikungunya', diagnoses: ['Chikungunya', 'Dengue', 'Zika', 'Influenza', 'Leptospirose'], diagnosticCheck: { question: 'Qual achado é mais discriminativo neste conjunto?', options: [{ id: 'a', label: 'Febre súbita acompanhada de poliartralgia intensa e potencialmente prolongada.' }, { id: 'b', label: 'Dor retro-orbitária como achado predominante.' }, { id: 'c', label: 'Conjuntivite não purulenta e prurido como queixa central.' }, { id: 'd', label: 'Tosse produtiva e dor pleurítica.' }], correctId: 'a' }, clues: { emergencia: [{ id: 'ck-em', role: 'emergencia', category: 'Clínica', level: 1, title: 'Dor que limita', text: 'Febre de início súbito acompanha dor articular intensa, edema em algumas articulações e dificuldade para caminhar.' }], infectologia: [{ id: 'ck-in', role: 'infectologia', category: 'Vigilância', level: 1, title: 'Diferencial sobreposto', text: 'Dengue e Zika podem circular no mesmo território; a intensidade da artralgia ajuda, mas não substitui a investigação.' }], epidemiologia: [{ id: 'ck-ep', role: 'epidemiologia', category: 'Exposição', level: 1, title: 'Ciclo do vetor', text: 'O território reúne recipientes com água parada e relatos de picadas durante o dia.' }], laboratorio: [{ id: 'ck-la', role: 'laboratorio', category: 'Laboratório', level: 1, title: 'Janela de teste', text: 'Na primeira semana, métodos de detecção direta em sangue podem apoiar a investigação.' }] }, interventions: [{ id: 'vector', icon: '🦟', label: 'Vetores', title: 'Eliminar criadouros', text: 'Reduzir locais de reprodução do mosquito no bairro.', tone: 'green', factor: .62 }, { id: 'care', icon: '🩺', label: 'Assistência', title: 'Organizar cuidado da dor', text: 'Orientar hidratação, repouso e avaliação clínica conforme necessidade.', tone: 'orange', factor: .7 }, { id: 'surveillance', icon: '📈', label: 'Vigilância', title: 'Acompanhar casos', text: 'Monitorar distribuição e evolução do agrupamento.', tone: 'blue', factor: .83 }, { id: 'communication', icon: '📣', label: 'Comunicação', title: 'Mobilizar prevenção', text: 'Orientar proteção contra picadas e eliminação de criadouros.', tone: 'purple', factor: .88 }], requiredInterventions: ['vector', 'care'], priorityAction: { label: 'PRIORIDADE ASSISTENCIAL', title: 'Organizar acolhimento da dor intensa', text: 'A equipe identifica pessoas com maior limitação e organiza avaliação segura.', action: 'Organizar acolhimento', completion: 'Acolhimento ativo', metricLabel: 'ACOLHIMENTO', before: 'sob pressão', after: 'organizado' }, cycleEvents: [], debrief: 'O caso é chikungunya. Febre súbita e dor articular intensa no contexto de Aedes sustentam a hipótese; a investigação deve considerar dengue e Zika.', learningPoints: ['Dor articular intensa é uma pista importante no diferencial.', 'Dengue, Zika e chikungunya podem circular no mesmo território.', 'Redução de criadouros protege contra mais de uma arbovirose.'], source: { label: 'OMS — Chikungunya', url: 'https://www.who.int/en/news-room/fact-sheets/detail/chikungunya' } },
]
