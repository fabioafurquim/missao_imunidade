...
- A **Central de Evolução** mostra níveis, XP, moedas, conquistas e emblemas cosméticos. As moedas só podem liberar personalização visual; nunca bloqueie uma decisão clínica, investigação, exame ou medida de contenção.
